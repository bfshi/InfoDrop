...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default=None, help="checkpoint to recover")
    # data aug stuff
    ...
    parser.add_argument("--tf_logger", action='store_true', help="If true will save tensorboard compatible logs")
    ...
    parser.add_argument("--token", default=-1, type=int, help="token for saving")
...
class Trainer:
    ...
    def do_training(self):
        ...
        print('saving best model to ./checkpoints/best_model_{}_{}.pth.tar'.format(test_res.max(), self.args.token))
        torch.save(self.model.state_dict(), './checkpoints/best_model_{}_{}.pth.tar'.format(test_res.max(), self.args.token))
